...
def StocksFucntion():
    ...
    if int(time_series)-1 == 0:
        URL = 'https://www.alphavantage.co/query?'+ Function[int(time_series)-1] +'&interval=60min'+ '&symbol=' + symbol +'&apikey=YM6ILKNSHGOU27Y5'
    elif int(time_series)-1 == 1 or int(time_series)-1 == 2 or int(time_series)-1 == 3:
        URL = 'https://www.alphavantage.co/query?'+ Function[int(time_series)-1] + '&symbol=' + symbol +'&apikey=YM6ILKNSHGOU27Y5'
